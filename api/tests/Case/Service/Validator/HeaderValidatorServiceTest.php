...
class HeaderValidatorServiceTest extends TestCase
{
    public function testValidate(): void
    {
        ...
        $this->assertEquals(ValidationResult::OK, $validator->validate(new Response(301, ['Location' => 'http://example.com'])));
        $this->assertEquals(ValidationResult::OK, $validator->validate(new Response(302, ['Location' => 'http://example.com'])));
